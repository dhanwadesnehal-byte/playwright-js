...
// EC-575: Check whether the OAuth Callback URL field is displayed
test(qase(575, 'EC-575: Check whether the OAuth Callback URL field is displayed'), async ({ page }) => {
  ...
  if (await oauthCallbackUrlField.count() > 0) {
    await expect(oauthCallbackUrlField).toBeVisible();
    console.log('OAuth Callback URL field is displayed');
  } else {

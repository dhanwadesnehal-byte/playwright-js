...
// EC-570: Check whether the Embedded App URL field is displayed
test(qase(570, 'EC-570: Check whether the Embedded App URL field is displayed'), async ({ page }) => {
  ...
  if (await embeddedAppUrlField.count() > 0) {
    await expect(embeddedAppUrlField).toBeVisible();
    console.log('Embedded App URL field is displayed');
  } else {

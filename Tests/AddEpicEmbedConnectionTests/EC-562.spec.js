...
// EC-562: Check whether the Client ID field is displayed
test(qase(562, 'EC-562: Check whether the Client ID field is displayed'), async ({ page }) => {
  ...
  if (await clientIdField.count() > 0) {
    ...
    console.log('Client ID field is displayed');
  } else {

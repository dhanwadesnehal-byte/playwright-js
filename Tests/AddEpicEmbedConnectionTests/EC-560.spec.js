...
// EC-560: Check whether a validation message is displayed when Connection Name is left empty
test(qase(560, 'EC-560: Check whether a validation message is displayed when Connection Name is left empty'), async ({ page }) => {
  ...
  if (await connectionNameField.count() > 0) {
    ...
    await connectionNameField.blur();
    ...
    if (await validationMessage.count() > 0) {
      ...
      console.log('Validation message is displayed when Connection Name is left empty');
    } else {
